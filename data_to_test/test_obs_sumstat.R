...
#   2. Runs obs.sumstat.ngs() on FASTA files generated by stdpopsim
...
cat("=======================================================\n")
cat("  Testing obs.sumstat.ngs() with stdpopsim FASTA data\n")
cat("=======================================================\n\n")
...
# ============================================================================
cat("--- Test 1: Vaquita2Epoch (single pop, 200 loci) ---\n")

pop_assign_vaq <- read.table("pop_assign_Vaquita2Epoch.txt", header=FALSE)
fasta_path_vaq <- normalizePath("fasta_Vaquita2Epoch")

cat("  Running obs.sumstat.ngs()...\n")
obs_vaq <- obs.sumstat.ngs(
  model        = Vaquita2Epoch,
  path.to.fasta = fasta_path_vaq,
...
# Python: s_mean_segs, s_var_segs, s_skew_segs, s_kurt_segs, ...
# R:      s_mean_segs, s_var_segs, s_skew_segs, s_kurt_segs, ...
...
# ============================================================================
cat("\n--- Test 2: OutOfAfrica_3G09 (2 pops, 200 loci) ---\n")

pop_assign_ooa <- read.table("pop_assign_OutOfAfrica_3G09.txt", header=FALSE)
fasta_path_ooa <- normalizePath("fasta_OutOfAfrica_3G09")

cat("  Running obs.sumstat.ngs()...\n")
obs_ooa <- obs.sumstat.ngs(
  model        = OutOfAfrica_3G09,
  path.to.fasta = fasta_path_ooa,
