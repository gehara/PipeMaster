#' Observed codemographic hypersummary statistics calculation
#' @description This function calculates the hypersummary statistics for a collection of fasta files present in a particular folder. It is intended to be used for codemographic inference in conjunction with simulations generated by sim.coexp or sim.coexp2. Here the same stats are calculated.
#' @param path.to.fasta The path to the directory containing the fasta files for all species/populations.
#' @author Marcelo Gehara
#' @return A list of hypersummary statistics.
